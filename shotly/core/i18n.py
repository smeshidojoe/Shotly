...
_RU = {
    ...
    "Fill":                         "Заливка",
    "Pen tool":                     "Перо",
    "Remove fill":                  "Снять заливку",
    "Nothing to fill here":         "Здесь нечего заливать",
    "Blur area":                    "Размытие области",
    "right click for shapes":       "правая кнопка — формы",
    "Blur brush":                   "Кисть размытия",
    ...
    "Erase everything":             "Стереть всё нарисованное",
