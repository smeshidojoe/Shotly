...
- **Рисование поверх снимка**: карандаш, линия, стрелка, прямоугольник, маркер и
  ...
  из четырёх толщин. Рисовать можно по всему экрану, не только внутри рамки; в
  файл и буфер уходит выделенная область, остальное обрезается.
...
Два инструмента в панели: **область** — тянете рамку, и всё внутри замазывается,
и **кисть** — водите мышью, размывается след. Оба умеют одно и то же:
...
shotly/core/            constants, config, i18n, hotkey, capture, blur,
                        saver, autostart, single, windows, updater, crashlog
shotly/ui/              overlay, toolbars, colorpop, blurpop, shapes,
                        settings_window, about, widgets, toast, theme, icons
